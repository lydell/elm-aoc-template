...
var $author$project$AB$sandStart = _Utils_Tuple2(500, 0);
var $author$project$AB$adjustBoundsForPartB = function (bounds) {
	var height = (bounds.z + 1) - bounds.A;
	var _v0 = $author$project$AB$sandStart;
	var x = _v0.a;
	var xMax = x + height;
	var xMin = x - height;
	return {
		P: A2($elm$core$Basics$max, xMax, bounds.P),
		F: A2($elm$core$Basics$min, xMin, bounds.F),
		z: bounds.z + 1,
		A: bounds.A
	};
};
										...
										if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
											...
											if ((!_v2.a.$) && (!_v2.b.$)) {
												...
												return $elm$core$Result$Ok(
													_Utils_Tuple2(aInt, bInt));
											} else {
												return $elm$core$Result$Err(
													'Line ' + ($elm$core$String$fromInt(lineIndex + 1) + (', segment ' + ($elm$core$String$fromInt(segmentIndex + 1) + (': Invalid ints: ' + segment)))));
											}
										} else {
											return $elm$core$Result$Err(
												'Line ' + ($elm$core$String$fromInt(lineIndex + 1) + (', segment ' + ($elm$core$String$fromInt(segmentIndex + 1) + (': Expected one comma, but got: ' + segment)))));
										}
									}),
...
var $author$project$AB$wallsToBounds = function (walls) {
	var _v0 = $elm$core$List$unzip(
		$elm$core$List$concat(
			A2(
				$elm$core$List$cons,
				_List_fromArray(
					[$author$project$AB$sandStart]),
				walls)));
	var xs = _v0.a;
	var ys = _v0.b;
	return {
		P: $author$project$AB$maximum(xs),
		F: $author$project$AB$minimum(xs),
		z: $author$project$AB$maximum(ys),
		A: $author$project$AB$minimum(ys)
	};
};
...
var $author$project$AB$Wall = 0;
var $author$project$AB$range = F2(
	function (a, b) {
		return A2(
			$elm$core$List$range,
...
var $author$project$AB$lineToCoordinates = function (line) {
	if (line.b && line.b.b) {
		var _v1 = line.a;
		var x1 = _v1.a;
		var y1 = _v1.b;
		...
		var y2 = _v3.b;
		var rest = _v2.b;
		var coordinates = _Utils_eq(x1, x2) ? A2(
			$elm$core$List$map,
			function (y) {
				return _Utils_Tuple2(
					_Utils_Tuple2(x1, y),
			...
			A2($author$project$AB$range, y1, y2)) : A2(
			$elm$core$List$map,
			function (x) {
				return _Utils_Tuple2(
					_Utils_Tuple2(x, y1),
			...
			A2($author$project$AB$range, x1, x2));
		return _Utils_ap(
			coordinates,
			$author$project$AB$lineToCoordinates(
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(x2, y2),
					rest)));
...
var $author$project$AB$wallsToGrid = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$concatMap($author$project$AB$lineToCoordinates),
	$elm$core$Dict$fromList);
var $author$project$AB$initPart = function (model) {
	var _v0 = $author$project$AB$parse(model.R);
	if (!_v0.$) {
		var walls = _v0.a;
		var bounds = $author$project$AB$wallsToBounds(walls);
		var adjustedBounds = function () {
			var _v1 = model.s;
			if (!_v1) {
				return bounds;
			} else {
				return $author$project$AB$adjustBoundsForPartB(bounds);
			}
		}();
		return _Utils_update(
			...
			{
				H: adjustedBounds,
				k: $author$project$AB$sandStart,
				f: $author$project$AB$wallsToGrid(walls),
...
var $author$project$AB$init = function (_v0) {
	...
	return _Utils_Tuple2(
		$author$project$AB$initPart(
			{
				H: $author$project$AB$wallsToBounds(_List_Nil),
				k: $author$project$AB$sandStart,
				C: fps,
				Q: $elm$core$String$fromInt(fps),
				f: $elm$core$Dict$empty,
				R: $author$project$Input$input,
				I: $elm$core$Maybe$Nothing,
				s: 0,
				j: false,
				K: false,
...
var $author$project$AB$StepToEndStarted = {$: 3};
var $author$project$AB$fpsMin = 1;
var $elm$core$Basics$not = _Basics_not;
var $elm$core$Process$sleep = _Process_sleep;
var $author$project$AB$Sand = 1;
...
var $author$project$AB$step = function (model) {
	...
	var _v1 = A2(
		...
		model.f);
	if (_v1.$ === 1) {
		if (_Utils_cmp(y, model.H.z) > -1) {
			var _v2 = model.s;
			if (!_v2) {
				return _Utils_update(
					model,
					{k: $author$project$AB$sandStart, j: false});
			} else {
				return _Utils_update(
					model,
					{
			...
			if (_v4.$ === 1) {
				...
				return _Utils_update(
					model,
					{
						...
						j: _Utils_eq(
							_Utils_Tuple2(x, y),
							$author$project$AB$sandStart) ? false : model.j
					});
			}
		}
	}
			...
			case 5:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							C: function () {
								var _v1 = $elm$core$String$toInt(input);
								if (!_v1.$) {
									var fps = _v1.a;
...
var $author$project$AB$PlayPauseToggled = {$: 1};
var $author$project$AB$StepToEndClicked = {$: 2};
...
var $author$project$AB$countSand = A2(
	$elm$core$Basics$composeR,
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$AB$SwitchPartClicked(model.s))
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										$elm$core$Basics$always(
											$author$project$AB$SwitchPartClicked(0))),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onCheck(
										$elm$core$Basics$always(
											$author$project$AB$SwitchPartClicked(1))),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Sand count: ' + $elm$core$String$fromInt(
							$author$project$AB$countSand(model.f)))
					])),
				A2(
...
var $author$project$AB$viewSand = F2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill('tan')
					]),
				attributes),
			_List_Nil);
	});
var $author$project$AB$viewCurrentSand = F2(
	function (fps, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return A2(
			$author$project$AB$viewSand,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$transform(
					'translate(' + ($elm$core$String$fromInt(x) + (',' + ($elm$core$String$fromInt(y) + ')')))),
					$elm$svg$Svg$Attributes$style(
					'transition: transform ' + ($elm$core$String$fromFloat(1000 / fps) + 'ms linear'))
				]),
			_Utils_Tuple2(0, 0));
	});
...
var $author$project$AB$viewStationarySand = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(
				$author$project$AB$viewSand(_List_Nil)),
...
var $author$project$AB$viewWalls = function (walls) {
	var d = A2(
		$elm$core$String$join,
		' ',
		A2(
			...
			$elm$core$List$indexedMap(
				F2(
					function (index, _v0) {
						var x = _v0.a;
						var y = _v0.b;
						return (!index) ? ('M' + ($elm$core$String$fromInt(x) + (',' + $elm$core$String$fromInt(y)))) : ('L' + ($elm$core$String$fromInt(x) + (',' + $elm$core$String$fromInt(y))));
					})),
			walls));
	return A2(
		$elm$svg$Svg$path,
	...
	var viewBox = $elm$svg$Svg$Attributes$viewBox(
		A2(
			...
			A2(
				...
				_List_fromArray(
					[bounds.F - padding, bounds.A - padding, (bounds.P - bounds.F) + (2 * padding), (bounds.z - bounds.A) + (2 * padding)]))));
	return A3(
		...
		_List_fromArray(
			[
				_Utils_Tuple2(
				'viewWalls',
				$author$project$AB$viewWalls(model.S)),
				_Utils_Tuple2(
				'viewSandStart',
				A2(
					$author$project$AB$viewSand,
					...
					$author$project$AB$sandStart)),
				_Utils_Tuple2(
				'viewCurrentSand' + $elm$core$String$fromInt(
					$elm$core$Dict$size(model.f)),
				A2($author$project$AB$viewCurrentSand, model.C, model.k)),
				_Utils_Tuple2(
				'viewSand',
				$author$project$AB$viewStationarySand(model.f))
			]));
};
...
var $author$project$AB$main = $elm$browser$Browser$element(
	{aI: $author$project$AB$init, aO: $author$project$AB$subscriptions, aQ: $author$project$AB$update, aR: $author$project$AB$view});
